...
/* 8 bit registers */
#define R_AH		gen.A.val.I8_reg.h_reg
#define R_AL		gen.A.val.I8_reg.l_reg
#define R_BH		gen.B.val.I8_reg.h_reg
#define R_BL		gen.B.val.I8_reg.l_reg
#define R_CH		gen.C.val.I8_reg.h_reg
#define R_CL		gen.C.val.I8_reg.l_reg
#define R_DH		gen.D.val.I8_reg.h_reg
#define R_DL		gen.D.val.I8_reg.l_reg

/* 16 bit registers */
#define R_AX		gen.A.val.I16_reg.x_reg
#define R_BX		gen.B.val.I16_reg.x_reg
#define R_CX		gen.C.val.I16_reg.x_reg
#define R_DX		gen.D.val.I16_reg.x_reg

/* 32 bit extended registers */
#define R_EAX		gen.A.val.I32_reg.e_reg
#define R_EBX		gen.B.val.I32_reg.e_reg
#define R_ECX		gen.C.val.I32_reg.e_reg
#define R_EDX		gen.D.val.I32_reg.e_reg

/* special registers */
#define R_SP		spc.SP.val.I16_reg.x_reg
#define R_BP		spc.BP.val.I16_reg.x_reg
#define R_SI		spc.SI.val.I16_reg.x_reg
#define R_DI		spc.DI.val.I16_reg.x_reg
#define R_IP		spc.IP.val.I16_reg.x_reg
#define R_FLG		spc.FLAGS

/* special registers */
#define R_ESP		spc.SP.val.I32_reg.e_reg
#define R_EBP		spc.BP.val.I32_reg.e_reg
#define R_ESI		spc.SI.val.I32_reg.e_reg
#define R_EDI		spc.DI.val.I32_reg.e_reg
#define R_EIP		spc.IP.val.I32_reg.e_reg
...
#define MEM_TYPE_SET(ADDR, VAL) \
  do { \
    if (VAL) \
      (emu->mem_type)[(ADDR) / 64] |= (1 << (((ADDR) / 8) % 8)); \
    else \
      (emu->mem_type)[(ADDR) / 64] &= ~(1 << (((ADDR) / 8) % 8)); \
  } while (0)

#define MEM_TYPE_GET(ADDR) \
      (!!((emu->mem_type)[(ADDR) / 64] & (1 << (((ADDR) / 8) % 8))))

void x86emu_new(x86emu_t *emu, unsigned def_mem_perm, unsigned def_io_perm, u8 *mem_type);
